(function (React) {
    ...
    const Spinner = Object.values(IconsModule).find((mod) => mod?.toString && /Spinner\)}\),.\.createElement\(\"path\",{d:\"M18 /.test(mod.toString()));
    ...
    var RepoSort;
    (function (RepoSort) {
        RepoSort[RepoSort["Alpha"] = 0] = "Alpha";
        RepoSort[RepoSort["Likes"] = 1] = "Likes";
        RepoSort[RepoSort["Downloads"] = 2] = "Downloads";
        RepoSort[RepoSort["Newest"] = 3] = "Newest";
        RepoSort[RepoSort["Oldest"] = 4] = "Oldest";
    })(RepoSort || (RepoSort = {}));
    var TargetType;
    (function (TargetType) {
        TargetType[TargetType["All"] = 0] = "All";
        TargetType[TargetType["Boot"] = 1] = "Boot";
        TargetType[TargetType["Suspend"] = 2] = "Suspend";
    ...
    const AnimationProvider = ({ serverAPI, children }) => {
        const [repoSort, setRepoSort] = React.useState(RepoSort.Newest);
        const [repoResults, setRepoResults] = React.useState([]);
        const [targetType, setTargetType] = React.useState(TargetType.All);
        const [lastSync, setLastSync] = React.useState(new Date().getTime());
        const [localAnimations, setLocalAnimations] = React.useState([]);
        const [customAnimations, setCustomAnimations] = React.useState([]);
        const [downloadedAnimations, setDownloadedAnimations] = React.useState([]);
        ...
        const loadBackendState = async () => {
            const { result } = await serverAPI.callPluginMethod('getState', {});
            setDownloadedAnimations(result.
                downloaded_animations
                .map((json) => new RepoResult(json))
                .sort(sortByName));
        ...
        const searchRepo = async (reload = false) => {
        ...
        const downloadAnimation = async (id) => {
        ...
        return (window.SP_REACT.createElement(AnimationContext.Provider, { value: {
                repoResults,
                searchRepo,
                repoSort,
                setRepoSort,
                ...
                customAnimations,
                localAnimations,
                allAnimations: downloadedAnimations.concat(customAnimations, localAnimations).sort(sortByName),
                settings,
                saveSettings,
                lastSync,
                loadBackendState,
    ...
    const RepoResultCard = ({ result, onActivate }) => {
        const { EventType, EventType28, OuterWrapper, EventPreviewContainer, EventImageWrapper, EventImage, Darkener, EventSummary, EventInfo, GameIconAndName, GameName, Title, RightSideTitles, ShortDateAndTime, EventDetailTimeInfo, InLibraryView } = ExtractedClasses.getInstance().found;
        return (window.SP_REACT.createElement("div", { className: 'Panel', style: {
                margin: 0,
                minWidth: 0,
                overflow: 'hidden'
            } },
            window.SP_REACT.createElement("div", { className: OuterWrapper, style: {
                    height: '317px'
                } },
                window.SP_REACT.createElement("div", { className: `${EventType} ${EventType28}` }, result.target === 'boot' ? 'Boot' : 'Suspend'),
                window.SP_REACT.createElement(Focusable, { focusWithinClassName: 'gpfocuswithin', className: `${EventPreviewContainer} Panel`, onActivate: onActivate, style: {
                        margin: 0,
                        marginBottom: '15px'
                    } },
                    window.SP_REACT.createElement("div", { className: EventImageWrapper },
                        window.SP_REACT.createElement("img", { src: result.preview_image, style: { width: '100%', height: '160px', objectFit: 'cover' }, className: EventImage }),
                        window.SP_REACT.createElement("div", { className: Darkener }),
                        window.SP_REACT.createElement("div", { className: EventSummary, style: { display: 'flex', alignItems: 'center', justifyContent: 'center' } },
                            window.SP_REACT.createElement(FaDownload, { style: { marginRight: '5px' } }),
                            " ",
                            result.downloads,
                            window.SP_REACT.createElement(FaThumbsUp, { style: { marginLeft: '10px', marginRight: '5px' } }),
                            " ",
                            result.likes)),
                    window.SP_REACT.createElement("div", { className: `${EventInfo} ${InLibraryView}` },
                        window.SP_REACT.createElement("div", { className: EventDetailTimeInfo },
                            window.SP_REACT.createElement(Focusable, null,
                                window.SP_REACT.createElement("div", { className: RightSideTitles }, "Updated"),
                                window.SP_REACT.createElement("div", { className: ShortDateAndTime }, result.relative_date))),
                        window.SP_REACT.createElement("div", { className: Title, style: { overflowWrap: 'break-word', wordWrap: 'break-word', width: '100%' } }, result.name),
                        window.SP_REACT.createElement("div", { className: GameIconAndName },
                            window.SP_REACT.createElement("div", { className: GameName, style: { overflowWrap: 'break-word', wordWrap: 'break-word', width: '100%' } }, result.author)))))));
    };

    const RepoResultModal = ({ result, onDownloadClick, isDownloaded, onDeleteClick, ...props }) => {
        ...
        const { GameIconAndName, GameName } = ExtractedClasses.getInstance().found;
        return (window.SP_REACT.createElement(ModalRoot, { ...props },
            window.SP_REACT.createElement("div", { style: { display: 'flex', flexDirection: 'row' } },
                window.SP_REACT.createElement("div", { style: { width: '50%' } },
                    window.SP_REACT.createElement("video", { style: { width: '100%', height: 'auto' }, poster: result.preview_image, autoPlay: true, controls: true },
                        window.SP_REACT.createElement("source", { src: result.preview_video, type: "video/webm" }),
                        window.SP_REACT.createElement("source", { src: result.download_url, type: "video/webm" }))),
                window.SP_REACT.createElement("div", { style: { display: 'flex', width: '50%', flexDirection: 'column', paddingLeft: '15px' } },
                    window.SP_REACT.createElement("div", { style: { flex: 1 } },
                        window.SP_REACT.createElement("h3", { style: { margin: 0 } }, result.name),
                        window.SP_REACT.createElement("div", { className: GameIconAndName },
                            window.SP_REACT.createElement("div", { className: GameName },
                                "Uploaded by ",
                                result.author)),
                        window.SP_REACT.createElement("p", { style: { overflowWrap: 'break-word', wordWrap: 'break-word', fontSize: '0.8em' } }, result.description)),
                    !onDeleteClick && window.SP_REACT.createElement(DialogButton, { disabled: downloaded || downloading, onClick: download }, (downloaded) ? 'Downloaded' : (downloading) ? 'Downloading…' : 'Download Animation'),
                    onDeleteClick && window.SP_REACT.createElement(DialogButton, { style: { background: 'var(--gpColor-Red)', color: '#fff' }, onClick: deleteAnimation }, "Delete Animation")))));
    };

    const AnimationBrowserPage = () => {
        const { searchRepo, repoResults, repoSort, targetType, setTargetType, setRepoSort, downloadAnimation, downloadedAnimations } = useAnimationContext();
        const [query, setQuery] = React.useState('');
        const [loading, setLoading] = React.useState(repoResults.length === 0);
        const [filteredResults, setFilteredResults] = React.useState(repoResults);
        ...
        if (loading) {
            return (window.SP_REACT.createElement("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' } },
                window.SP_REACT.createElement(Spinner, { width: 32, height: 32 })));
        }
        return (window.SP_REACT.createElement("div", null,
            window.SP_REACT.createElement(Focusable, { style: {
                ...
                window.SP_REACT.createElement("form", { style: { flex: 1, marginRight: '30px' }, onSubmit: search },
                    window.SP_REACT.createElement(TextField, { onChange: ({ target }) => { setQuery(target.value); }, placeholder: 'Search Animations\u2026', 
                        // @ts-ignore
                        ref: searchField, bShowClearAction: true })),
                window.SP_REACT.createElement("div", { style: { marginRight: '15px' } },
                    window.SP_REACT.createElement(Dropdown, { menuLabel: 'Sort', rgOptions: sortOptions, selectedOption: repoSort, onChange: (data) => {
                            setRepoSort(data.data);
                        } })),
                window.SP_REACT.createElement("div", { style: { marginRight: '15px' } },
                    window.SP_REACT.createElement(Dropdown, { menuLabel: 'Animation Type', rgOptions: targetOptions, selectedOption: targetType, onChange: (data) => {
                            setTargetType(data.data);
                        } })),
                window.SP_REACT.createElement(DialogButton, { style: { flex: 0 }, onButtonUp: (e) => { if (e.detail.button === 1)
                        reload(); }, onMouseUp: reload }, "Reload")),
            window.SP_REACT.createElement(Focusable, { style: { minWidth: 0, display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gridAutoRows: '1fr', columnGap: '15px' } }, filteredResults.map((result, index) => window.SP_REACT.createElement(RepoResultCard, { key: `${result.id}-${index}`, result: result, onActivate: () => {
                    showModal(window.SP_REACT.createElement(RepoResultModal, { onDownloadClick: async () => { return downloadAnimation(result.id); }, result: result, isDownloaded: downloadedAnimations.find(animation => animation.id == result.id) != null }), findSP());
                } })))));
    };
        ...
        return (window.SP_REACT.createElement(Focusable, null,
            ...
            window.SP_REACT.createElement("ul", { style: { marginTop: "0px", marginBottom: "0px" } },
                window.SP_REACT.createElement("li", null,
                    window.SP_REACT.createElement("span", null, "TheLogicMaster - github.com/TheLogicMaster")),
                window.SP_REACT.createElement("li", null,
                    window.SP_REACT.createElement("span", null, "steve228uk - github.com/steve228uk"))),
            window.SP_REACT.createElement("h2", { style: { fontWeight: "bold", fontSize: "1.5em", marginBottom: "0px" } }, "Credits"),
            window.SP_REACT.createElement("ul", { style: { marginTop: "0px", marginBottom: "0px" } },
                window.SP_REACT.createElement("li", null,
                    window.SP_REACT.createElement("span", null, "Beebles: UI Elements - github.com/beebls")),
                window.SP_REACT.createElement("li", null,
                    window.SP_REACT.createElement("span", null, "Animations from steamdeckrepo.com"))),
            ...
            window.SP_REACT.createElement("h2", { style: { fontWeight: "bold", fontSize: "1.5em", marginBottom: "0px" } }, "More Info"),
            window.SP_REACT.createElement("p", null, "For more information about Animation Changer including how to manually install animations, please see the README."),
            window.SP_REACT.createElement(DialogButton, { style: { width: 300 }, onClick: () => {
                    Navigation.NavigateToExternalWeb('https://github.com/TheLogicMaster/SDH-AnimationChanger/blob/main/README.md');
                } }, "View README")));
    };

    const InstalledAnimationsPage = () => {
        const searchField = React.useRef();
        const { downloadedAnimations, deleteAnimation } = useAnimationContext();
        const [query, setQuery] = React.useState('');
        const [targetType, setTargetType] = React.useState(TargetType.All);
        const [sort, setSort] = React.useState(RepoSort.Alpha);
        const [filteredAnimations, setFilteredAnimations] = React.useState(downloadedAnimations);
        const search = (e) => {
            searchField.current?.element?.blur();
            e.preventDefault();
        };
        ...
        if (downloadedAnimations.length === 0) {
            return (window.SP_REACT.createElement("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' } },
                window.SP_REACT.createElement("h2", null, "No Animations Downloaded")));
        }
        return (window.SP_REACT.createElement("div", null,
            window.SP_REACT.createElement(Focusable, { style: {
                    display: 'flex',
                ...
                window.SP_REACT.createElement("form", { style: { flex: 1, marginRight: '30px' }, onSubmit: search },
                    window.SP_REACT.createElement(TextField, { onChange: ({ target }) => { setQuery(target.value); }, placeholder: 'Search Animations\u2026', 
                        ...
                        ref: searchField, bShowClearAction: true })),
                window.SP_REACT.createElement("div", { style: { marginRight: '15px' } },
                    window.SP_REACT.createElement(Dropdown, { menuLabel: 'Sort', rgOptions: sortOptions, selectedOption: sort, onChange: (data) => {
                            setSort(data.data);
                        } })),
                window.SP_REACT.createElement("div", { style: { marginRight: '15px' } },
                    window.SP_REACT.createElement(Dropdown, { menuLabel: 'Animation Type', rgOptions: targetOptions, selectedOption: targetType, onChange: (data) => {
            ...
            window.SP_REACT.createElement(Focusable, { style: { minWidth: 0, display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gridAutoRows: '1fr', columnGap: '15px' } }, filteredAnimations.map((result, index) => window.SP_REACT.createElement(RepoResultCard, { key: `${result.id}-${index}`, result: result, onActivate: async () => {
                    showModal(window.SP_REACT.createElement(RepoResultModal, { result: result, isDownloaded: true, onDeleteClick: async () => {
    ...
    const Content = () => {
        ...
        const [suspendAnimationOptions, setSuspendAnimationOptions] = React.useState([]);
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            ...
            window.SP_REACT.createElement(PanelSection, { title: "Animations" },
                window.SP_REACT.createElement(PanelSectionRow, null,
                    window.SP_REACT.createElement(DropdownItem, { label: "Boot", menuLabel: "Boot Animation", rgOptions: bootAnimationOptions, selectedOption: settings.boot, onChange: ({ data }) => {
                            saveSettings({ ...settings, boot: data });
                        } })),
                window.SP_REACT.createElement(PanelSectionRow, null,
                    window.SP_REACT.createElement(DropdownItem, { label: "Suspend", menuLabel: "Suspend Animation", rgOptions: suspendAnimationOptions, selectedOption: settings.suspend, onChange: ({ data }) => {
                            saveSettings({ ...settings, suspend: data });
                        } })),
                window.SP_REACT.createElement(PanelSectionRow, null,
                    window.SP_REACT.createElement(DropdownItem, { label: "Throbber", menuLabel: "Throbber Animation", rgOptions: suspendAnimationOptions, selectedOption: settings.throbber, onChange: ({ data }) => {
                            saveSettings({ ...settings, throbber: data });
                        } })),
                window.SP_REACT.createElement(PanelSectionRow, null,
                    window.SP_REACT.createElement(ButtonItem, { layout: "below", onClick: shuffle }, "Shuffle"))),
            window.SP_REACT.createElement(PanelSection, { title: 'Settings' },
                window.SP_REACT.createElement(PanelSectionRow, null,
                    window.SP_REACT.createElement(ToggleField, { label: 'Shuffle on Boot', onChange: (checked) => { saveSettings({ ...settings, randomize: (checked) ? 'all' : '' }); }, checked: settings.randomize == 'all' })),
                window.SP_REACT.createElement(PanelSectionRow, null,
                    window.SP_REACT.createElement(ToggleField, { label: 'Force IPv4', onChange: (checked) => { saveSettings({ ...settings, force_ipv4: checked }); }, checked: settings.force_ipv4 })),
                window.SP_REACT.createElement(PanelSectionRow, null,
                    window.SP_REACT.createElement(ButtonItem, { layout: "below", onClick: reloadConfig }, "Reload Config")))));
    };
    const AnimationManagerRouter = () => {
        const [currentTabRoute, setCurrentTabRoute] = React.useState("AnimationBrowser");
            ...
            window.SP_REACT.createElement(Tabs, { activeTab: currentTabRoute, 
                ...
                onShowTab: (tabID) => {
                ...
                }, tabs: [
                    {
                        ...
                        content: window.SP_REACT.createElement(AnimationBrowserPage, null),
                        id: "AnimationBrowser",
                        renderTabAddon: () => window.SP_REACT.createElement("span", { className: TabCount }, repoResults.length)
                    },
                    {
                        title: "Installed Animations",
                        content: window.SP_REACT.createElement(InstalledAnimationsPage, null),
                        id: "InstalledAnimations",
                        renderTabAddon: () => window.SP_REACT.createElement("span", { className: TabCount }, downloadedAnimations.length)
                    },
                    {
    ...
    var index = definePlugin((serverApi) => {
        serverApi.routerHook.addRoute("/animation-manager", () => (window.SP_REACT.createElement(AnimationProvider, { serverAPI: serverApi },
            window.SP_REACT.createElement(AnimationManagerRouter, null))));
        return {
            title: window.SP_REACT.createElement("div", { className: staticClasses.Title }, "Animation Changer"),
            content: (window.SP_REACT.createElement(AnimationProvider, { serverAPI: serverApi },
                window.SP_REACT.createElement(Content, null))),
            icon: window.SP_REACT.createElement(FaRandom, null)
        };
    });
