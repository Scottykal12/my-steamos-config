(function (React) {
    ...
    findModule((mod) => typeof mod === 'object' && mod?.Title?.includes('quickaccessmenu'));
    ...
    const gamepadSliderClasses = findModule((mod) => typeof mod === 'object' && mod?.SliderControlPanelGroup?.includes('gamepadslider'));
    ...
    const ColorPickerModal = ({ closeModal, onConfirm = () => { }, title = 'Color Picker', defaultH = 0, defaultS = 100, defaultL = 50, defaultA = 1, }) => {
        ...
        const [L, setL] = React.useState(defaultL);
    ...
    async function openFilePicker(path) {
        return await server$1.openFilePicker(path, true);
    }
    function fetchThemePath() {
        return server$1.callPluginMethod("fetch_theme_path", {});
    }
    ...
    function getInstalledThemes() {
        ...
        return server$1.callPluginMethod("get_themes", {}).then((data) => {
            if (data.success) {
    ...
    function reloadBackend() {
        return server$1.callPluginMethod("reset", {}).then(() => {
            getInstalledThemes();
        });
    }
    function getThemes$1() {
        return server$1.callPluginMethod("get_themes", {});
    }
    function setThemeState(name, state) {
        return server$1.callPluginMethod("set_theme_state", {
            name: name,
            state: state,
        });
    }
    function setPatchOfTheme(themeName, patchName, value) {
        return server$1.callPluginMethod("set_patch_of_theme", {
            themeName: themeName,
            patchName: patchName,
            value: value,
        });
    ...
    function setComponentOfThemePatch(themeName, patchName, componentName, value) {
        return server$1.callPluginMethod("set_component_of_theme_patch", {
            themeName: themeName,
            patchName: patchName,
    ...
    function downloadThemeFromUrl(themeId) {
        ...
        return server$1.callPluginMethod("download_theme_from_url", { id: themeId, url: apiUrl });
    }
    function deleteTheme(themeName) {
        return server$1.callPluginMethod("delete_theme", { themeName: themeName });
    }
    function storeRead(key) {
        return server$1.callPluginMethod("store_read", { key: key });
    }
    function storeWrite(key, value) {
        return server$1.callPluginMethod("store_write", { key: key, val: value });
    }
    function getBackendVersion() {
        return server$1.callPluginMethod("get_backend_version", {});
    }
    function dummyFunction() {
        return server$1.callPluginMethod("dummy_function", {});
    }
    function unpinTheme(id) {
        const { unpinnedThemes } = globalState$1.getPublicState();
        const setGlobalState = globalState$1.setGlobalState.bind(globalState$1);
    ...
    function generatePreset(name) {
        return server$1.callPluginMethod("generate_preset_theme", { name: name });
    }

    function calcButtonColor(installStatus) {
        let filterCSS = "";
    ...
    async function genericGET(fetchPath, requiresAuth = false, customAuthToken = undefined) {
    ...
    function getThemes(searchOpts, apiPath, globalStateVarName, setSnapIndex, requiresAuth = false) {
        const setGlobalState = globalState.setGlobalState.bind(globalState);
        const queryStr = generateParamStr(searchOpts.filters !== "All" ? searchOpts : { ...searchOpts, filters: "" }, "CSS.-Preset.");
    ...
    function toggleStar(themeId, isStarred, authToken, apiUrl) {
        return server
    ...
    */
    ...
    const PatchComponent = ({ data, selectedLabel, themeName, patchName, bottomSeparatorValue }) => {
        if (selectedLabel === data.on) {
            ...
            function setComponentAndReload(value) {
                resolve(setComponentOfThemePatch(themeName, patchName, data.name, // componentName
                value), () => {
                    getInstalledThemes();
                });
            }
            switch (data.type) {
                case "image-picker":
                    ...
                    return (window.SP_REACT.createElement(PanelSectionRow, null,
                        window.SP_REACT.createElement(ButtonItem, { bottomSeparator: bottomSeparatorValue, onClick: () => getRootPath(), layout: "below" },
                ...
                case "color-picker":
                    ...
                    return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                        window.SP_REACT.createElement(PanelSectionRow, null,
                            window.SP_REACT.createElement(ButtonItem, { bottomSeparator: bottomSeparatorValue, onClick: () => showModal(
                                ...
                                window.SP_REACT.createElement(ColorPickerModal, { onConfirm: (HSLString) => {
    ...
    const ThemePatch = ({ data, index, fullArr, themeName }) => {
        ...
        switch (data.type) {
            case "slider":
                return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement(PanelSectionRow, null,
                        window.SP_REACT.createElement(SliderField, { bottomSeparator: bottomSeparatorValue, label: ` ↳ ${data.name}`, min: 0, max: data.options.length - 1, value: selectedIndex, onChange: (value) => {
                                execute(setPatchOfTheme(themeName, data.name, data.options[value]));
                                setIndex(value);
                    ...
                    data.components.length > 0 ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null, data.components.map((e) => (window.SP_REACT.createElement(PatchComponent, { data: e, selectedLabel: selectedLabel, themeName: themeName, patchName: data.name, bottomSeparatorValue: bottomSeparatorValue }))))) : null));
            case "checkbox":
                return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement(PanelSectionRow, null,
                        window.SP_REACT.createElement(ToggleField, { bottomSeparator: bottomSeparatorValue, label: ` ↳ ${data.name}`, checked: data.value === "Yes", onChange: (bool) => {
                                const newValue = bool ? "Yes" : "No";
                                execute(setPatchOfTheme(themeName, data.name, newValue));
                                setLabel(newValue);
            ...
            case "dropdown":
                return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement(PanelSectionRow, null,
                        window.SP_REACT.createElement(DropdownItem, { bottomSeparator: bottomSeparatorValue, label: ` ↳ ${data.name}`, menuLabel: `${data.name}`, rgOptions: data.options.map((x, i) => {
                                return { data: i, label: x };
                            }), selectedOption: selectedIndex, onChange: (index) => {
                                setIndex(index.data);
                                data.value = index.label;
                                setLabel(data.value);
                                execute(setPatchOfTheme(themeName, data.name, data.value));
                            } })),
                    data.components.length > 0 ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null, data.components.map((e) => (window.SP_REACT.createElement(PatchComponent, { data: e, selectedLabel: selectedLabel, themeName: themeName, patchName: data.name, bottomSeparatorValue: bottomSeparatorValue }))))) : null));
            case "none":
                return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement(PanelSectionRow, null,
                        window.SP_REACT.createElement("span", { style: { color: "#dcdedf" } },
                            "\u21B3 ",
                            data.name)),
                    data.components.length > 0 ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null, data.components.map((e) => (window.SP_REACT.createElement(PatchComponent, { data: e, selectedLabel: selectedLabel, themeName: themeName, patchName: data.name, bottomSeparatorValue: bottomSeparatorValue }))))) : null));
            default:
    ...
    const ThemeToggle = ({ data, collapsible = false, }) => {
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement(PanelSectionRow, null,
                window.SP_REACT.createElement(ToggleField, { bottomSeparator: data.enabled && data?.patches?.length > 0 ? "none" : "standard", checked: data.enabled, label: data.name, description: isPreset ? `Preset` : `${data.version} | ${data.author}`, onChange: (switchValue) => {
                        // Actually enabling the theme
                        resolve(setThemeState(data.name, switchValue), () => {
                            getInstalledThemes();
                        });
                        // Re-collapse menu
                        setCollapsed(true);
                        ...
                        if (data.dependencies.length > 0) {
                            if (switchValue === true) {
                                toast(`${data.name} enabled other themes`, 
                            ...
                            if (!data.flags.includes(Flags.dontDisableDeps)) {
                                toast(`${data.name} disabled other themes`, 
                                // @ts-ignore
                                `${data.dependencies.length === 1
    ...
    function LoadMoreButton({ fetchPath = "/themes", origSearchOpts, themeArr, themeArrVarName, paramStrFilterPrepend = "", setSnapIndex = undefined, }) {
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null, themeArr.items.length < themeArr.total ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement(DialogButton, { onClick: loadMore, disabled: loading }, "Load More"))) : null));
    }
    ...
    const VariableSizeCard = ({ data: e, cols: size, showTarget = true, refPassthrough = undefined, searchOpts, prevSearchOptsVarName, }) => {
        ...
        window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement("div", { style: { position: "relative" } },
                installStatus === "outdated" && (window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_SingleItem_NotifBubble", style: {
                        position: "absolute",
                ...
                window.SP_REACT.createElement(Focusable, { ref: refPassthrough, focusWithinClassName: "gpfocuswithin", onActivate: () => {
                    ...
                    }, className: "CssLoader_ThemeBrowser_SingleItem_BgImage", style: {
                    ...
                    window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_SingleItem_BgOverlay", style: {
                            display: "flex",
                        ...
                        window.SP_REACT.createElement("span", { className: "CssLoader_ThemeBrowser_SingleItem_ThemeName", style: {
                                textAlign: "center",
                        ...
                        showTarget && (window.SP_REACT.createElement("span", { className: "CssLoader_ThemeBrowser_SingleItem_ThemeTarget", style: {
                                marginTop: "-6px",
                                fontSize: smallText[size],
                                height: targetHeight[size],
                                textShadow: "rgb(48, 48, 48) 0px 0 10px",
                            } }, e.target)),
                        window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_SingleItem_PreviewImage", style: {
                                width: imgWidth[size],
                                backgroundImage: imageURLCreator(),
                                backgroundSize: "cover",
                                backgroundRepeat: "no-repeat",
                        ...
                        window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_SingleItem_AuthorVersionContainer", style: {
                                width: imgWidth[size],
                                textAlign: "center",
                                display: "flex",
                            ...
                            window.SP_REACT.createElement("span", { className: "CssLoader_ThemeBrowser_SingleItem_AuthorText", style: {
                                    marginRight: "auto",
                                    marginLeft: "2px",
                                    textShadow: "rgb(48, 48, 48) 0px 0 10px",
                                    whiteSpace: "nowrap",
                            ...
                            window.SP_REACT.createElement("span", { className: "CssLoader_ThemeBrowser_SingleItem_VersionText", style: {
                                    marginLeft: "auto",
                                    marginRight: "2px",
                                    textShadow: "rgb(48, 48, 48) 0px 0 10px",
                                } }, e.version)))))));
            ...
            window.SP_REACT.createElement(PanelSectionRow, null,
                window.SP_REACT.createElement(Focusable, { style: { display: "flex", maxWidth: "100%" } },
                    window.SP_REACT.createElement("div", { style: {
                        ...
                        window.SP_REACT.createElement(Dropdown, { menuLabel: "Sort", rgOptions: formattedFilters.order, strDefaultLabel: "Last Updated (Newest)", selectedOption: searchOpts.order, onChange: (e) => {
                                setGlobalState(prevSearchOptsVarName, searchOpts);
                    ...
                    window.SP_REACT.createElement("div", { className: "CSSLoader_FilterDropDown_Container", style: {
                        ...
                        window.SP_REACT.createElement(Dropdown, { menuLabel: "Filter", rgOptions: formattedFilters.filters, strDefaultLabel: "All", selectedOption: searchOpts.filters, onChange: (e) => {
                                setGlobalState(prevSearchOptsVarName, searchOpts);
            ...
            window.SP_REACT.createElement("div", { style: { display: "flex", justifyContent: "center" } },
                window.SP_REACT.createElement(Focusable, { style: { display: "flex", alignItems: "center", width: "96%" } },
                    window.SP_REACT.createElement("div", { style: { minWidth: "55%", marginRight: "auto" } },
                        window.SP_REACT.createElement(TextField, { label: "Search", value: searchOpts.search, onChange: (e) => {
                                setGlobalState(prevSearchOptsVarName, searchOpts);
                                setGlobalState(searchOptsVarName, { ...searchOpts, search: e.target.value });
                            } })),
                    window.SP_REACT.createElement(DialogButton, { onClick: onReload, style: {
                            maxWidth: "20%",
                            height: "50%",
                        } },
                        window.SP_REACT.createElement(TiRefreshOutline, { style: { transform: "translate(0, 2px)" } }),
                    ...
                    window.SP_REACT.createElement("div", { style: { maxWidth: "20%", minWidth: "20%", marginLeft: "auto" }, className: "CssLoader_ThemeBrowser_ScaleSlider" },
                        window.SP_REACT.createElement(SliderField, { min: 3, max: 5, step: 1, value: browserCardSize, onChange: (num) => {
    ...
    function ThemeSettingsModalRoot({ stateClass, closeModal, selectedTheme, }) {
        return (window.SP_REACT.createElement(ModalRoot, { onCancel: closeModal, onEscKeypress: closeModal },
            window.SP_REACT.createElement(CssLoaderContextProvider, { cssLoaderStateClass: stateClass },
    ...
    function ThemeSettingsModal({ closeModal, selectedTheme, }) {
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement("div", { style: {
                ...
                themeData ? (window.SP_REACT.createElement("div", { style: { width: "90%" } },
                    window.SP_REACT.createElement(ThemeToggle, { data: themeData, collapsible: false }))) : (window.SP_REACT.createElement("span", null, "No Theme Data")),
                window.SP_REACT.createElement(DialogButton, { style: { width: "fit-content" }, onClick: () => {
                        closeModal();
                    } }, "Close"))));
    }
    ...
    function CreatePresetModal({ closeModal, enabledNumber, }) {
        const [presetName, setPresetName] = React.useState("");
        return (window.SP_REACT.createElement(ConfirmModal, { strTitle: "Create Preset", strDescription: `This preset will combine all ${enabledNumber} themes you currently have enabled. Enabling/disabling it will toggle them all at once.`, strOKButtonText: "Create", onCancel: closeModal, onOK: () => {
                if (presetName.length === 0) {
                    toast("No Name!", "Please add a name to your preset.");
                    return;
                }
            ...
            window.SP_REACT.createElement(TextField, { label: "Preset Name", value: presetName, onChange: (e) => {
                    setPresetName(e.target.value);
                } })));
    }

    function AllThemesModalRoot({ stateClass, closeModal, }) {
        return (window.SP_REACT.createElement(ModalRoot, { onCancel: closeModal, onEscKeypress: closeModal },
            window.SP_REACT.createElement(CssLoaderContextProvider, { cssLoaderStateClass: stateClass },
                window.SP_REACT.createElement(AllThemesModal, { stateClass: stateClass, closeModal: closeModal }))));
    }
    function AllThemesModal({ stateClass, closeModal, }) {
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement("h1", { style: { marginBlockEnd: "10px", marginBlockStart: "0px" } }, "Your Themes"),
            window.SP_REACT.createElement("style", null, `
        ...
        `),
            window.SP_REACT.createElement(Focusable, { style: { display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gridGap: "1em" } }, sortedList.map((e) => {
                ...
                return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement("div", { className: "CSSLoader_FullTheme_EntryContainer" },
                        window.SP_REACT.createElement("div", { className: "CSSLoader_FullTheme_ToggleContainer" },
                            window.SP_REACT.createElement(ToggleField, { bottomSeparator: "none", label: window.SP_REACT.createElement("span", { className: "CSSLoader_FullTheme_ThemeLabel" }, e.name), checked: e.enabled, onChange: (switchValue) => {
                                    // Actually enabling the theme
                                    resolve(setThemeState(e.name, switchValue), () => {
                                        getInstalledThemes();
                                    });
                                    // Dependency Toast
                                    if (e.dependencies.length > 0) {
                                        if (switchValue === true) {
                                            toast(`${e.name} enabled other themes`, 
                                            // This lists out the themes by name, but often overflowed off screen
                                            // @ts-ignore
                                            // `${new Intl.ListFormat().format(data.dependencies)} ${
                                            //   data.dependencies.length > 1 ? "are" : "is"
                                        ...
                                        if (!e.flags.includes(Flags.dontDisableDeps)) {
                                            toast(`${e.name} disabled other themes`, 
                                            // @ts-ignore
                                            `${e.dependencies.length === 1
                        ...
                        window.SP_REACT.createElement(DialogButton, { className: "CSSLoader_FullTheme_DialogButton", onClick: () => {
                                if (isPinned) {
                                    unpinTheme(e.id);
                                }
                                else {
                            ...
                            } }, isPinned ? (window.SP_REACT.createElement(AiFillEye, { className: "CSSLoader_FullTheme_IconTranslate" })) : (window.SP_REACT.createElement(AiOutlineEyeInvisible, { className: "CSSLoader_FullTheme_IconTranslate" }))),
                        window.SP_REACT.createElement(DialogButton, { className: "CSSLoader_FullTheme_DialogButton", onClick: () => {
                                showModal(
                                // @ts-ignore
                                window.SP_REACT.createElement(ThemeSettingsModalRoot, { stateClass: stateClass, selectedTheme: e.id }));
                            } },
                            window.SP_REACT.createElement(ImCog, { className: "CSSLoader_FullTheme_IconTranslate" })))));
            })),
            window.SP_REACT.createElement(PanelSectionRow, null,
                window.SP_REACT.createElement(ButtonItem, { layout: "below", bottomSeparator: "standard", onClick: () => {
                        showModal(
                        // @ts-ignore
                        window.SP_REACT.createElement(CreatePresetModal, { enabledNumber: localThemeList.filter((e) => e.enabled).length }));
                    } }, "Create Preset")),
            window.SP_REACT.createElement(PanelSectionRow, null,
    ...
    const ThemeBrowserPage = () => {
        const { browseThemeList: themeArr, themeSearchOpts: searchOpts, apiShortToken, apiFullToken, serverFilters, browserCardSize = 3, prevSearchOpts, } = useCssLoaderState();
        const [backendVersion, setBackendVer] = React.useState(5);
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            ...
            window.SP_REACT.createElement(Focusable, { style: {
                    ...
                    rowGap: "5px",
                    columnGap: "5px",
                } }, themeArr.items.map((e, i) => (window.SP_REACT.createElement(VariableSizeCard, { refPassthrough: i === indexToSnapTo ? endOfPageRef : undefined, data: e, cols: browserCardSize, showTarget: true, searchOpts: searchOpts, prevSearchOptsVarName: "prevSearchOpts" })))),
            window.SP_REACT.createElement("div", { style: {
                    marginTop: "1em",
                    marginBottom: "1em",
                    display: "flex",
    ...
    const UninstallThemePage = () => {
        ...
        function handleUninstall(listEntry) {
            ...
            resolve(deleteTheme(listEntry.name), () => {
        ...
        function updateTheme(remoteEntry) {
            if (remoteEntry && remoteEntry?.id) {
                const id = remoteEntry.id;
                setUninstalling(true);
                resolve(downloadThemeFromUrl(id), () => {
                    reloadBackend();
                    setUninstalling(false);
                });
            }
        ...
        React.useEffect(() => {
            if (localThemeList.length > 0) {
                ...
                localThemeList.forEach((e) => {
                    const entryInBrowseList = browseThemeList.items.find((f) => e.id === f.id || e.id === f.name);
                ...
                if (idsToQuery.length > 0) {
                    ...
                    genericGET(`/themes/ids${queryStr}`).then((data) => {
                        if (data) {
                            themeArr.push(...data);
                        }
                        formatData();
        ...
        if (localThemeList.filter((e) => !e.bundled).length === 0) {
            return (window.SP_REACT.createElement(PanelSectionRow, null,
                window.SP_REACT.createElement("span", null, "No custom themes installed, find some in the 'Browse Themes' tab.")));
        }
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement("div", null,
                window.SP_REACT.createElement("div", null, localThemeList.map((e, i) => {
                    ...
                    return (window.SP_REACT.createElement(PanelSectionRow, null,
                        window.SP_REACT.createElement("div", { style: {
                            ...
                            window.SP_REACT.createElement("span", null, e.name),
                            ...
                            window.SP_REACT.createElement(Focusable, { style: {
                                ...
                                updateStatus === "outdated" && (window.SP_REACT.createElement(DialogButton, { style: {
                                        marginRight: "8px",
                                        minWidth: "calc(50% - 8px)",
                                        maxWidth: "calc(50% - 8px)",
                                        filter: "invert(6%) sepia(90%) saturate(200%) hue-rotate(160deg) contrast(122%)",
                                    }, onClick: () => updateTheme(remoteEntry), disabled: isUninstalling },
                                    window.SP_REACT.createElement(AiOutlineDownload, null))),
                                updateStatus === "local" && (window.SP_REACT.createElement("span", { style: {
                                        position: "absolute",
                                        top: "50%",
                                        right: "50%",
                                        transform: "translate(0, -50%)",
                                    } },
                                    window.SP_REACT.createElement("i", null, "Local Theme"))),
                                window.SP_REACT.createElement(DialogButton, { style: {
                                        minWidth: "calc(50% - 8px)",
                                        maxWidth: "calc(50% - 8px)",
                                        marginLeft: "auto",
                                    }, onClick: () => handleUninstall(e), disabled: isUninstalling },
    ...
    const ExpandedViewPage = () => {
        const { localThemeList: installedThemes, currentExpandedTheme, isInstalling, apiUrl, apiFullToken, setGlobalState, } = useCssLoaderState();
        ...
        const [imageUrl, setImageUrl] = React.useState(`https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Steam_Deck_logo_%28blue_background%29.svg/2048px-Steam_Deck_logo_%28blue_background%29.svg.png`);
        ...
        async function toggleStar$1() {
            if (apiFullToken) {
                ...
                if (fullThemeData && newToken) {
                    toggleStar(fullThemeData.id, isStarred, newToken, apiUrl).then((bool) => {
                        if (bool) {
                            setFullData({
                                ...fullThemeData,
                                starCount: isStarred
                ...
                toast("Not Logged In!", "You can only star themes if logged in.");
            }
        }
        function installTheme() {
            if (fullThemeData?.id) {
                setGlobalState("isInstalling", true);
                resolve(downloadThemeFromUrl(fullThemeData.id), () => {
                    reloadBackend().then(() => {
                ...
                toast("Error Downloading!", "Can't find theme ID");
            }
        }
        function checkIfThemeInstalled(themeObj) {
            ...
            if (currentExpandedTheme?.id) {
                ...
                genericGET(`/themes/${currentExpandedTheme.id}`).then((data) => {
                    ...
                    if (data?.images[0]?.id && data.images[0].id !== "MISSING") {
                        ...
                        setImageUrl(`https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Steam_Deck_logo_%28blue_background%29.svg/2048px-Steam_Deck_logo_%28blue_background%29.svg.png`);
                    }
                    setLoaded(true);
                });
            }
        ...
        if (!loaded) {
          ...
          `),
                window.SP_REACT.createElement("div", { style: {
                    ...
                    window.SP_REACT.createElement("span", { style: { fontWeight: "bold", fontSize: "2.5em" } }, "Loading"))));
        }
                    ...
                    window.SP_REACT.createElement("div", { style: {
                        ...
                        window.SP_REACT.createElement("div", { style: {
                            ...
                            window.SP_REACT.createElement("div", { style: {
                                ...
                                window.SP_REACT.createElement("span", null, fullThemeData.specifiedAuthor),
                                window.SP_REACT.createElement("span", null, fullThemeData.target),
                                window.SP_REACT.createElement("span", null, fullThemeData.version),
                                window.SP_REACT.createElement("div", { style: { display: "flex", flexDirection: "column" } },
                                    !apiFullToken && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                                        window.SP_REACT.createElement("div", { style: { display: "flex", alignItems: "center", fontSize: "1em" } },
                                            window.SP_REACT.createElement(BsStarFill, null),
                                            window.SP_REACT.createElement("span", null, fullThemeData.starCount)))),
                                    window.SP_REACT.createElement("div", { style: { display: "flex", alignItems: "center", fontSize: "1em" } },
                                        window.SP_REACT.createElement(FiDownload, null),
                                        window.SP_REACT.createElement("span", null, fullThemeData.download.downloadCount)))),
                            window.SP_REACT.createElement("div", null,
                                !!apiFullToken && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                                    window.SP_REACT.createElement(PanelSectionRow, null,
                                        window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_ExpandedView_StarButton", style: {
                                            ...
                                            window.SP_REACT.createElement(ButtonItem, { layout: "below", onClick: toggleStar$1, disabled: blurStarButton },
                                                window.SP_REACT.createElement("div", { style: {
                                                        display: "flex",
                                                        alignItems: "center",
                                                        justifyContent: "center",
                                                    ...
                                                    isStarred ? (window.SP_REACT.createElement(BsStarFill, { style: { height: "1.25em", width: "1.25em" } })) : (window.SP_REACT.createElement(BsStar, { style: { height: "1.25em", width: "1.25em" } })),
                                                    " ",
                                                    window.SP_REACT.createElement("span", null, fullThemeData.starCount))))))),
                                window.SP_REACT.createElement(PanelSectionRow, null,
                                    window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_ExpandedView_InstallButtonColorFilter", style: {
                                            // This padding here overrides the default padding put on PanelSectionRow's by Valve
                                            // Before this, I was using negative margin to "shrink" the element, but this is a much better solution
                                            paddingTop: "0px",
                                            paddingBottom: "0px",
                                        ...
                                        window.SP_REACT.createElement(ButtonItem, { layout: "below", disabled: installStatus === "installed" || isInstalling, onClick: () => {
                                                installTheme();
                                            } },
                                ...
                                window.SP_REACT.createElement(PanelSectionRow, null,
                                    window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_ExpandedView_BackButtonContainer", style: {
                                            // This padding here overrides the default padding put on PanelSectionRow's by Valve
                                            paddingTop: "0px",
                                            paddingBottom: "0px",
                                        } },
                                        window.SP_REACT.createElement(ButtonItem
                                        // They forgot to add the ref property to the buttons interface, so I'm just tsignoring the warning
                                        // @ts-ignore
                                        , { 
                                            // They forgot to add the ref property to the buttons interface, so I'm just tsignoring the warning
                                            // @ts-ignore
                                            ref: backButtonRef, bottomSeparator: "none", layout: "below", onClick: () => {
                                            ...
                                            window.SP_REACT.createElement("span", { className: "CssLoader_ThemeBrowser_ExpandedView_BackText" }, "Back"))))))),
                    window.SP_REACT.createElement("div", { style: {
                            flex: "1 1 0%",
                            flexGrow: "1",
                        } },
                        window.SP_REACT.createElement("span", null, fullThemeData?.description || (window.SP_REACT.createElement("i", { style: {
                                color: "#666",
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement("div", { style: {
                ...
                window.SP_REACT.createElement("span", null, "Error fetching selected theme, please go back and retry."))));
    };

    // THIS FILE IS AUTO GENERATED
    function SiWebauthn (props) {
    ...
    const LogInPage = () => {
        ...
        window.SP_REACT.createElement("div", null,
            window.SP_REACT.createElement("div", null,
                apiFullToken ? (window.SP_REACT.createElement("h1", { style: { fontWeight: "bold", fontSize: "2em" } }, "Your Account")) : (window.SP_REACT.createElement("h1", { style: { fontSize: "1em", fontWeight: "normal" } },
                    window.SP_REACT.createElement("span", { style: { fontWeight: "bold", fontSize: "2em" } }, "Log In"),
                    " - Create an account on deckthemes.com and generate a deck token on your account page.")),
                apiFullToken ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement(Focusable, { style: { display: "flex", alignItems: "center" } },
                        window.SP_REACT.createElement("div", { style: { minWidth: "65%", marginRight: "auto" } }, apiMeData ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                            window.SP_REACT.createElement("span", null,
                                "Logged In As ",
                                apiMeData.username))) : (window.SP_REACT.createElement("span", null, "Loading..."))),
                        window.SP_REACT.createElement(DialogButton, { style: {
                                maxWidth: "30%",
                                height: "50%",
                                marginLeft: "auto",
                            ...
                            window.SP_REACT.createElement("span", null, "Unlink My Deck"))))) : (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement(Focusable, { style: { display: "flex", alignItems: "center", width: "100%" } },
                        window.SP_REACT.createElement("div", { style: { minWidth: "65%", marginRight: "auto" } },
                            window.SP_REACT.createElement(TextField, { disabled: !!apiFullToken, label: "DeckThemes Account Key", bIsPassword: true, value: shortTokenInterimValue, onChange: (e) => setShortTokenIntValue(e.target.value) })),
                        window.SP_REACT.createElement(DialogButton, { disabled: shortTokenInterimValue.length !== 12, onClick: () => {
                            ...
                            window.SP_REACT.createElement(SiWebauthn, { style: { height: "1.5em", width: "1.5em" } }),
                            window.SP_REACT.createElement("span", null, "Log In")))))),
            window.SP_REACT.createElement(Focusable, null,
                window.SP_REACT.createElement("div", null,
                    window.SP_REACT.createElement("h1", { style: { fontWeight: "bold", fontSize: "2em", marginBottom: "0px" } }, "About CSSLoader"),
                    window.SP_REACT.createElement("div", { style: { display: "flex", gap: "4em", fontSize: "0.9em" } },
                        window.SP_REACT.createElement("div", null,
                            window.SP_REACT.createElement("h2", { style: { fontWeight: "bold", fontSize: "1.5em", marginBottom: "0px" } }, "Developers"),
                        ...
                        window.SP_REACT.createElement("div", null,
                            window.SP_REACT.createElement("h2", { style: { fontWeight: "bold", fontSize: "1.5em", marginBottom: "0px" } }, "Support"),
                            window.SP_REACT.createElement("span", null,
    ...
    function StarredThemesPage() {
        const { apiFullToken, apiMeData, starredSearchOpts: searchOpts, starredServerFilters: serverFilters, starredThemeList: themeArr, browserCardSize, prevStarSearchOpts: prevSearchOpts, } = useCssLoaderState();
        function reloadThemes() {
        ...
        if (!apiFullToken) {
            return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                window.SP_REACT.createElement("div", { style: {
                    ...
                    window.SP_REACT.createElement("span", { style: { fontSize: "1.5em", fontWeight: "bold" } }, "You Are Not Logged In!"),
                    window.SP_REACT.createElement("span", null, "Link your deck to your deckthemes.com account to sync Starred Themes"))));
        }
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            ...
            window.SP_REACT.createElement(Focusable, { style: {
                    ...
                    rowGap: "5px",
                    columnGap: "5px",
                } }, themeArr.items.map((e, i) => (window.SP_REACT.createElement(VariableSizeCard, { refPassthrough: i === indexToSnapTo ? endOfPageRef : undefined, data: e, cols: browserCardSize, showTarget: true, searchOpts: searchOpts, prevSearchOptsVarName: "prevStarSearchOpts" })))),
            window.SP_REACT.createElement("div", { style: {
                    marginTop: "1em",
                    marginBottom: "1em",
                    display: "flex",
    ...
    function SubmissionsPage() {
        const { apiFullToken, submissionSearchOpts: searchOpts, submissionServerFilters: serverFilters, submissionThemeList: themeArr, browserCardSize, prevSubSearchOpts: prevSearchOpts, apiMeData, } = useCssLoaderState();
        function reloadThemes() {
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            ...
            window.SP_REACT.createElement(Focusable, { style: {
                    ...
                    rowGap: "5px",
                    columnGap: "5px",
                } }, themeArr.items.map((e, i) => (window.SP_REACT.createElement(VariableSizeCard, { refPassthrough: i === indexToSnapTo ? endOfPageRef : undefined, data: e, cols: browserCardSize, showTarget: true, searchOpts: searchOpts, prevSearchOptsVarName: "setPrevSubSearchOpts" })))),
            window.SP_REACT.createElement("div", { style: {
                    marginTop: "1em",
                    marginBottom: "1em",
                    display: "flex",
    ...
    const Content = ({ stateClass }) => {
        ...
        return (window.SP_REACT.createElement(PanelSection, { title: "Themes" },
            dummyFuncResult ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                ...
                themeList.length > 0 ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement("style", null, `
                ...
                `),
                    window.SP_REACT.createElement(Focusable, { className: "CSSLoader_ThemeListContainer" },
                        unpinnedThemes.length === themeList.length ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                            window.SP_REACT.createElement("span", null, "You have no pinned themes currently, themes that you pin from the \"Your Themes\" popup will show up here"))) : (window.SP_REACT.createElement(window.SP_REACT.Fragment, null, themeList
                            .filter((e) => !unpinnedThemes.includes(e.id))
                            .map((x) => (window.SP_REACT.createElement(ThemeToggle, { data: x, collapsible: true }))))),
                        window.SP_REACT.createElement(PanelSectionRow, null,
                            window.SP_REACT.createElement(ButtonItem, { layout: "below", onClick: () => {
                                    // @ts-ignore
                                    showModal(window.SP_REACT.createElement(AllThemesModalRoot, { stateClass: stateClass }));
                                } }, "Your Themes"))))) : (window.SP_REACT.createElement("span", null, "You have no themes currently, click on \"Download Themes\" to download some!")))) : (window.SP_REACT.createElement(PanelSectionRow, null,
            ...
            window.SP_REACT.createElement(PanelSectionRow, null,
                window.SP_REACT.createElement(ButtonItem, { layout: "below", onClick: () => reload() }, "Refresh"))));
    };
    const ThemeManagerRouter = () => {
        ...
        return (window.SP_REACT.createElement("div", { style: {
            ...
            window.SP_REACT.createElement(Tabs, { activeTab: currentTab, onShowTab: (tabID) => {
                        ...
                        : []),
                    {
                        ...
                        content: window.SP_REACT.createElement(UninstallThemePage, null),
                        id: "InstalledThemes",
                    },
                    {
    ...
    var index = definePlugin((serverApi) => {
        ...
        return {
            ...
            title: window.SP_REACT.createElement("div", null, "CSSLoader"),
            alwaysRender: true,
            content: (window.SP_REACT.createElement(CssLoaderContextProvider, { cssLoaderStateClass: state },
                window.SP_REACT.createElement(Content, { stateClass: state }))),
